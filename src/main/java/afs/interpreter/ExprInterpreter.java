...
//                var shapeExpr = exprRotateNode.getLeftExpression();      // Shape to rotate
//                var pivotExpr = exprRotateNode.getMiddleExpression();    // X-coordinate of pivot
//                var angleExpr = exprRotateNode.getRightExpression();      // Angle of rotation
//
//                // Evaluate the shape
//                var shapeResult = evalExpr(envV, envF, envE, location, shapeExpr, store, imgStore);
//                Object shapeValue = shapeResult.getValue0();
...
//                var pivotResult = evalExpr(envV, envF, envE, location, pivotExpr, updatedStore, updatedImgStore);
//                Point pivotValue = (Point) pivotResult.getValue0();
//                updatedStore = pivotResult.getValue1();
//                updatedImgStore = pivotResult.getValue2();
//
//                var pivotXResult = evalExpr(envV, envF, envE, location, ,updatedStore, updatedImgStore);
//
//                double pivotX = ((Number) pivotValue).doubleValue();
//
//
//
//                // Evaluate the angle

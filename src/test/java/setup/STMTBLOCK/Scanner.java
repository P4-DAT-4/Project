...
public class Scanner {
	...
	static {
		...
		literals.put("if", 11);
		literals.put("then", 14);
		literals.put("else", 15);
		literals.put("while", 16);
		literals.put("do", 17);
		literals.put("return", 18);
		literals.put("true", 34);
		literals.put("false", 35);
		literals.put("shape", 36);
		literals.put("void", 37);
		literals.put("int", 38);
		literals.put("double", 39);
		literals.put("bool", 40);
		literals.put("string", 41);

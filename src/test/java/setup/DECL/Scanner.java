...
public class Scanner {
	...
	static {
		...
		literals.put("if", 9);
		literals.put("then", 12);
		literals.put("else", 13);
		literals.put("text", 14);
		literals.put("line", 15);
		literals.put("to", 17);
		literals.put("curve", 18);
		literals.put("place", 19);
		literals.put("at", 20);
		literals.put("scale", 21);
		literals.put("by", 22);
		literals.put("rotate", 23);
		literals.put("around", 24);
		literals.put("true", 39);
		literals.put("false", 40);
		literals.put("shape", 43);
		literals.put("void", 44);
		literals.put("int", 45);
		literals.put("double", 46);
		literals.put("bool", 47);
		literals.put("string", 48);
